...
# Load YOLOv8 model
model = YOLO(r"C:\Users\xfdhd\Downloads\train3-20250308T154830Z-001\train3\weights\best.pt") # Replace with your model path

# Streamlit app
st.image(r"C:\Users\xfdhd\Downloads\LOGO_HEMAI.png", use_column_width=True)
